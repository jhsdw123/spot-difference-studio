...
const OUT = 'C:/Users/User/AutoIncome_2026/spot-hunt-game/icons/';
function logo(pad) {
  const s = 100 - pad * 2;
...
for (const [file, size, pad] of [['icon-192.png', 192, 8], ['icon-512.png', 512, 8], ['icon-180.png', 180, 8], ['icon-maskable-512.png', 512, 16]]) {
  writeFileSync(OUT + file, new Resvg(logo(pad), { fitTo: { mode: 'width', value: size } }).render().asPng());
  console.log(file);
}
